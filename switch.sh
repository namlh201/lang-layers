...
mkdir -p switch/${MODEL}/${SRC_LANG}-${TGT_LANG}

run $ENVDIR/bin/python analyze_switch_layers.py \
    "lens_output_all/${MODEL}/${DATASET}_${SRC_LANG}_${TGT_LANG}/lens_${DATASET}_${SRC_LANG}_${TGT_LANG}_sample${SAMPLE}.json" \
    --lang-dist "token_lang_dist_fineweb_dataset_${MODEL}.json" \
    --middle-lang $MID_LANG \
    --output switch/${MODEL}/${SRC_LANG}-${TGT_LANG}/switch

# run $ENVDIR/bin/python visualize_lens.py \
#     "lens_output_all/${MODEL}/${DATASET}_${SRC_LANG}_${TGT_LANG}/lens_${DATASET}_${SRC_LANG}_${TGT_LANG}_sample${SAMPLE}.json" \
#     --tokenizer $TOKENIZER \
#     --output heatmaps/${MODEL}/${SRC_LANG}-${TGT_LANG}/lens_top1_heatmap.png

# run $ENVDIR/bin/python visualize_combined.py \
#     "lens_output_all/${MODEL}/${DATASET}_${SRC_LANG}_${TGT_LANG}/lens_${DATASET}_${SRC_LANG}_${TGT_LANG}_sample${SAMPLE}.json" \
#     --lang-dist "token_lang_dist_fineweb_dataset_${MODEL}.json" \
#     --middle-lang $MID_LANG \
#     --output heatmaps/${MODEL}/${SRC_LANG}-${TGT_LANG}/lang_heatmap

# run $ENVDIR/bin/python visualize_chinese_prob.py \
#     "lens_output_all/${MODEL}/${DATASET}_${SRC_LANG}_${TGT_LANG}/lens_${DATASET}_${SRC_LANG}_${TGT_LANG}_sample${SAMPLE}.json" \
#     --lang-dist "token_lang_dist_fineweb_dataset_${MODEL}.json" \
#     --output heatmaps/${MODEL}/${SRC_LANG}-${TGT_LANG}/lang_heatmap
...
# run $ENVDIR/bin/python visualize_trellis.py \
#     "lens_output_all/${MODEL}/${DATASET}_${SRC_LANG}_${TGT_LANG}/lens_${DATASET}_${SRC_LANG}_${TGT_LANG}_sample${SAMPLE}.json" \
#     --lang-dist "token_lang_dist_fineweb_dataset_${MODEL}.json" \
#     --middle-lang $MID_LANG \
#     --output heatmaps/${MODEL}/${SRC_LANG}-${TGT_LANG}/lang_heatmap
